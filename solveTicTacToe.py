...
class TicTacToeAgent():
    ...
    def __init__(self):
        ...
        self.goodones = {"cc1","c1c","1cc",
                         ...
                         "c1b","bc1","cb1",
                         "bc11","1bc1","11bc"}
    def rota_90(self,board):
      newB = [board[6],board[3],board[0],board[7],board[4],board[1],board[8],board[5],board[2]]
      return newB
  
    def rota_180(self,board):
      newB = [board[8],board[7],board[6],board[5],board[4],board[3],board[2],board[1],board[0]]
      return newB
  
    def rota_270(self,board):
      newB = [board[2],board[5],board[8],board[1],board[4],board[7],board[0],board[3],board[6]]
      return newB
  
    def x_mirror(self,board):
      newB = [board[2],board[1],board[0],board[5],board[4],board[3],board[8],board[7],board[6]]
      return newB
  
    def y_mirror(self,board):
      newB = [board[6],board[7],board[8],board[3],board[4],board[5],board[0],board[1],board[2]]
      return newB
    def xy_mirror(self,board):
      newB = [board[8],board[5],board[2],board[7],board[4],board[1],board[6],board[3],board[0]]
      return newB
    def yx_mirror(self,board):
      newB = [board[0],board[3],board[6],board[1],board[4],board[7],board[2],board[5],board[8]]
      return newB
  
  
    def evaluateOne(self, board):
      family = [board,self.rota_90(board),self.rota_180(board),self.rota_270(board),self.x_mirror(board),self.y_mirror(board),self.xy_mirror(board),self.yx_mirror(board)]
      
      if ([True, True, False, False, False, False, False, True, False] in family) or ([True, True, False, False, False, False, False, False, True] in family) or ([True, True, False, False, False, True, False, False, False] in family) :
        return 'd'
      if [False, False, False, False, False, False, False, False, False] in family:
        return 'c'
      if [True, False, False, False, False, False, False, False, False] in family or [False, True, False, False, False, False, False, False, False] in family or [True, False, False, False, False, True, False, True, False] in family :
        return '1'
      if [True, False, False, False, False, False, False, False, True] in family or [False, True, False, True, False, False, False, False, False] in family or [False, True, False, False, False, False, False, True, False] in family or [True, False, True, False, True, False, False, False, False] in family or [True, False, True, False, False, False, False, True, False] in family or [True, False, False, False, True, True, False, False, False] in family or [True, True, False, True, True, False, False, False, False] in family or [True, True, False, True, False, True, False, False, False] in family or [True, True, False, True, False, False, False, False, True] in family or [True, True, False, False, False, False, False, True, True] in family or [True, False, True, False, False, False, True, False, True] in family or [False, True, False, True, False, True, False, True, False] in family or [True, True, False, False, True, True, True, False, False] in family or [True, True, False, False, False, True, True, True, False] in family or [True, True, False, False, False, True, True, False, True] in family or [True, True, False, True, False, True, False, True, True] in family or [True, True, False, False, False, False, True, False, False] in family:
        return 'a'
      if [False, False, False, False, True, False, False, False, False] in family:
        return "cc"
      if [True, True, False, False, False, False, False, False, False] in family:
        return "ad"
      if [True, False, True, False, False, False, False, False, False] in family or [True, False, False, False, True, False, False, False, False] in family or [True, False, False, False, False, True, False, False, False] in family or [False, True, False, False, True, False, False, False, False] in family or [True, True, False, True, False, False, False, False, False] in family or [False, True, False, True, False, True, False, False, False] in family or [True, True, False, False, True, True, False, False, False] in family or [True, True, False, False, True, False, True, False, False] in family or [True, True, False, False, False, True, True, False, False] in family or [True, True, False, False, False, False, True, True, False] in family or [True, True, False, False, False, False, True, False, True] in family or [True, False, True, False, True, False, False, True, False] in family or [True, False, False, False, True, True, False, True, False] in family or [True, True, False, True, False, True, False, False, True] in family or [False, True, False, True, False, True, True, True, False] in family:
        return 'b'
      if [True, True, False, False, True, False, False, False, False] in family or [True, False, True, False, False, False, True, False, False] in family or [False, True, False, True, True, False, False, False, False] in family or [True, True, False, False, False, True, False, True, False] in family or [True, True, False, False, False, True, False, False, True] in family:
        return "ab"
      if board[0] and board[4] and board[8]:
          return "1"
      if board[2] and board[4] and board[6]:
    ...
    def getAction(self, gameState, gameRules):
      acts = gameState.getLegalActions(gameRules)
      ans = ""
      for act in acts:
        newB = gameState.generateSuccessor(act)
        if (self.evaluateOne(newB.boards[0]) + self.evaluateOne(newB.boards[1]) + self.evaluateOne(newB.boards[2])) in self.goodones:
          ans = act
      return ans
